...
public class FtpApplicationAdministrationService2 implements AdministrationService<FtpApplication> {
    ...
    public MasterDataAdministrationOperationSuccessServiceResult insert(final FtpApplication businessObject,
        final DialogUserIdInformation dialogUserIdInformation) throws DuplicateEntityException, ConstraintViolationException {

        final List<ValidationInformation> validationInformations =
            ftpApplicationValidator.validate(businessObject, CommonValidationContext.createInsert());
        ...
        final ChangeRecord changeRecordBean =
            changeRecordProtocolService.createAndPersistCreationChangeRecord(persistent, diffWrapperList,
